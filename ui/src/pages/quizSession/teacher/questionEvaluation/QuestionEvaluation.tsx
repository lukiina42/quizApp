...
const QuestionEvaluation = ({ 
  ...
  const totalAnswers = (questionEvaluation?.amountOfAnswersTotal ? questionEvaluation?.amountOfAnswersTotal : 0) - 
    (questionEvaluation?.amountOfCorrectAnswers ? questionEvaluation?.amountOfCorrectAnswers : 0)

  //the data passed into the chart of correct answers out of total answers
  const answersChartData = [
    { name: "Answers", Correct:  questionEvaluation?.amountOfCorrectAnswers, Total: totalAnswers }
  ]
      ...
      <div className='wrapperDiv'>
        ...
        <div className='barWrapper'>
          <ResponsiveContainer width="100%" height="100%" >
            <BarChart stackOffset="expand" data={answersChartData} layout="vertical" >
              <Tooltip cursor={{fill: 'white'}} wrapperStyle={{ top: -40 }}  content={<CustomTooltip labelFormatter={() => ""}/>}/>
